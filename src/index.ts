...
import type { BookInfo, DocMeta, SectionMeta } from './types';
...
export function getBooks(): BookInfo[] {
  const byBook = new Map<string, BookInfo>();
  const bookOfPath = new Map<string, string>();
